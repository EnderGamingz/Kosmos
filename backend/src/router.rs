...
fn get_user_router() -> KosmosRouter {
    Router::new()
        ...
        .route(
            "/avatar/:user_id",
            get(crate::routes::api::v1::auth::user::index::get_avatar_by_user_id),
        )
        .route(
            "/password",
...
fn get_album_router() -> KosmosRouter {
    Router::new()
        ...
        .route(
            "/:album_id/preview",
            put(crate::routes::api::v1::auth::album::update::update_album_preview),
        )
        .route(
            "/:album_id/link",
        ...
        .route(
            "/for",
            post(crate::routes::api::v1::auth::album::read::get_available_albums_for_files),
        )
}

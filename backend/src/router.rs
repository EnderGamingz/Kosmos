...
fn get_usage_router() -> KosmosRouter {
    Router::new()
        .route("/stats", get(crate::routes::api::v1::auth::user::usage::get_usage_stats))
        .route("/report", get(crate::routes::api::v1::auth::user::usage::get_usage_report))
}
...
fn get_multi_router() -> KosmosRouter {
    Router::new()
        .route("/", post(crate::routes::api::v1::auth::download::multi_download)
                .delete(crate::routes::api::v1::auth::folder::delete::multi_delete)
                .put(crate::routes::api::v1::auth::folder::multi_move))
        .route("/bin", post(crate::routes::api::v1::auth::file::bin::mark_files_for_deletion))
}

fn get_operation_router() -> KosmosRouter {
    Router::new()
        .route("/all", get(crate::routes::api::v1::auth::operation::get_all_operations))
}
...
fn get_search_router() -> KosmosRouter {
    Router::new()
        .route("/", get(crate::routes::api::v1::auth::search))
}
...
fn get_passkey_auth_router() -> KosmosRouter {
    Router::new()
        ...
        .route("/authentication/complete", post(crate::routes::api::v1::auth::passkey::authenticate::authentication_complete))
}
